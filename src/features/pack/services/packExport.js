...
import { getDesktopGroupDisplayTags, getDesktopGroupDisplayName } from '../model/groupMetadata';
import { getPackActiveDurationFromTasks, getPackActiveLabel } from '../model/packPageUtils';
...
export const getPackRoleHeading = (role, labels = {}) => ({
...
export const getPackFilterLabel = (filter, labels = {}) => ({
