              ...
              <div className="sheet-content">
                ...
                >
                  ...
                  <div className={`sheet-title-row ${isCalendarOpen ? 'calendar-open' : ''}`} onClick={() => {
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="16" viewBox="0 0 9 14" fill="none" className="sheet-title-icon" style={{ transform: isCalendarOpen ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 0.38s cubic-bezier(0.22, 1, 0.36, 1)' }}>
